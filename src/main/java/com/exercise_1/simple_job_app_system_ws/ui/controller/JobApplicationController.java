...
import com.exercise_1.simple_job_app_system_ws.service.JobApplicationService;
import com.exercise_1.simple_job_app_system_ws.shared.dto.JobApplicationDto;
import com.exercise_1.simple_job_app_system_ws.ui.model.request.ApplicationDetailsRequestModel;
import com.exercise_1.simple_job_app_system_ws.ui.model.response.JobApplicationRest;
...
public class JobApplicationController {
    ...
    public JobApplicationRest createApplication(@RequestBody ApplicationDetailsRequestModel applicationDetails) throws Exception
    {
    ...
    public List<JobApplicationRest> getAllApplications(@RequestParam(value = "page", defaultValue = "0") int page,
    ...
    public JobApplicationRest getApplicationById(@PathVariable String id){
    ...
    public JobApplicationRest statusOnHandler(@PathVariable String applicationId)
    {
        JobApplicationRest returnValue = new JobApplicationRest();
    ...
    public JobApplicationRest statusOffHandler(@PathVariable String applicationId)
    {
        JobApplicationRest returnValue = new JobApplicationRest();
